                    ...
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            ...
                            <form name="frmConsResxEmp"  class="border p-3 form" action="SvConsResxEmp" method="POST">
                               ...
                               <div class="row">
                                    <div class="col">
                                        <label for = "CboEmpleado" class="form-label">Seleccione el empleado cuyas reservas desea consultar:</label> 
                                         <select name ="CboEmpleado" class="form-control">
                                            <option value="-">-</option>
                                            <%                                                
                                                //Cargo los empleados en el combobox
                                                HttpSession sesion = request.getSession();
                                                
                                                List<Empleado> listaEmple =  (List) sesion.getAttribute("listaEmpleados");
                                                Empleado emple = new Empleado();
                                                
                                                if(listaEmple != null){
                                                for (int i = 0; i < listaEmple.size(); i++) {
                                                    emple = listaEmple.get(i);
                                                        out.println("<option value=\"" + emple.getIdPersona() + "\" " + ">" + emple.getNombre() + " " + emple.getApellido() + "</option>");
